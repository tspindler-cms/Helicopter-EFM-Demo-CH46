...
Next open CH46D.cpp and the .h files to edit them to your needs. The .cpp file contains all the available functions from DCS and the .h files are to help separate and organize systems.
